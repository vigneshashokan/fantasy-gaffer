...
export function Icon({ name, color = '#fff', size = 20 }: IconProps) {
  ...
  switch (name) {
    ...
    case 'pencil':
      return <Svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><Path d="M4 20h4l10-10a2.8 2.8 0 10-4-4L4 16v4z" /><Path d="M13.5 6.5l4 4" /></Svg>;
    default:
      return null;
  }
}
