...
- **Order / status (as of 2026-07-02):** seq-0 EAS dev build ✅ → **#42 PostHog** ✅ (PR #109) → **#36 push — Slice 1 only** ✅ (PR #110; dispatcher + channels **held to pre-launch**, blocked on EAS push creds) → **#38 price refresh + #80 staleTime** ✅ (PR #112) → **#39 offline read-cache** ✅ (PR #113) → **#37 live scoring — HELD to post-launch** (flag-gated, seasonal, off-season-untestable). **Phase 4's buildable pre-launch work is done → moved to Phase 5.**
...
- **Buildable now (no external blockers):** #46 privacy/ToS · #47 accessibility audit · #48 Maestro E2E · #49 first-run onboarding · #73 verify biometric on dev build · #50 i18n (optional) · #71 universal links (needs AASA/assetlinks hosting; domains registered).
